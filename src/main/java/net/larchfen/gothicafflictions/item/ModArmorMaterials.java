...
public class ModArmorMaterials {
    ...
    public static final Holder<ArmorMaterial> SILVER_ARMOR_MATERIAL = register("silver",
            ...
            }), SoundEvents.ARMOR_EQUIP_IRON,20, 0.0f,  0.0f, () -> ModItems.SILVER_INGOT.get());

    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
                                                  Holder<SoundEvent> equipSound, int enchantability, float toughness, float knockbackResistance,
                                                  Supplier<Item> ingredientItem) {
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(GothicAfflictions.MOD_ID, name);
